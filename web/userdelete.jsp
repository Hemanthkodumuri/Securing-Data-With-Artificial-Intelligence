...
<html>
    ...
    <body background="BacImages/images16.jpg">
        <center>
       <form name="form" method="post" action="UserDeleteServlet">
           <br>
           </br>
           <table width="" border="0">
                <tr>
                    <td>
                        <div align="center">
                            <font size="10" face="Colonna MT">Group Manager Validation</font></div>
                    </td>
                </tr>
            </table>
           <br>
           ...
           <table width="250" border="0">
               <tr>
                   <td>                       
                           <div align="center"><font size="5" face="Comic Sans Ms">GroupName:</font></div>

...
Select WebSite: <select name="slist1" onchange="SList.getSelect('slist2', this.value);">
 <option>- - -</option>
  <% 
          ...
          con3=DriverManager.getConnection("jdbc:mysql://localhost:3306/mona","password","password");
...
<table width="250" border="0">
    ...
    <body onLoad="javascript: showHide('popup');">
        ...
        <tr>
          ...
          {
          Class.forName("com.mysql.jdbc.Driver");
          con2=DriverManager.getConnection("jdbc:mysql://localhost:3306/mona","password","password");
